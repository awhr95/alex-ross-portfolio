  ...
  return (
    <section className="techstack">
      ...
      <section className="techstack__icon-container">
        ...
        <a href="https://www.javascript.com/" className="techstack__stack-link">
          <figure className="techstack__figures">
            <img className="techstack__icon" src={Javascript} alt="Html icon" />
        ...
        <a href="https://expressjs.com/" className="techstack__stack-link">
          <figure className="techstack__figures">
            <img className="techstack__icon" src={Express} alt="Express icon" />
